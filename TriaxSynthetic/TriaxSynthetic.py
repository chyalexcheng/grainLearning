...
#obsDataFile = 'syntheticObsData_8000.txt'

#obsDataFile = 'Test_0.5.data'
#data = np.loadtxt(obsDataFile,skiprows=1)
#fOpen = open(obsDataFile,'r')
...
baseFolder ="../"
obsFile ="syntheticObsData.txt"

rateApplied = 0.1
loadData = [Vector3(-conf,-conf,-i*0.04*rateApplied) for i in range(0,51)]
loadData.reverse()
print(len(loadData))
...
#spMat = O.materials.append(
   #FrictMat(young=E,poisson=v,frictionAngle=ctrMu,density=rho))
...
#plt.plot(plot.data['e_z'],plot.data['s33_over_s11'])
#plt.show() 
